...
<html lang="en">
    ...
    ?>
      ...
      #twitter, #twitter-mask {
        ...
        height: 20px;
        overflow: hidden;
        background: url(sites/all/libraries/jackbox/deploy/jackbox/img/graphics/social/twitter.png) no-repeat;

      }

      .twitter-webkit {

        background: url(sites/all/libraries/jackbox/deploy/jackbox/img/graphics/social/twitter_webkit.png) no-repeat !important;

      }

      .twitter-mac {

        background: url(sites/all/libraries/jackbox/deploy/jackbox/img/graphics/social/twitter_mac.png) no-repeat !important;
      ...
      #google, #google-mask {
        ...
        height: 20px;
        overflow: hidden;
        background: url(sites/all/libraries/jackbox/deploy/jackbox/img/graphics/social/google.png) no-repeat;
      ...
      #facebook-mask, #facebook {
        ...
        margin-left: 0;
        overflow: hidden;
        background: url(sites/all/libraries/jackbox/deploy/jackbox/img/graphics/social/facebook.png) no-repeat;

      }

      .facebook-mac {

        background: url(sites/all/libraries/jackbox/deploy/jackbox/img/graphics/social/facebook_mac.png) no-repeat !important;
    ...
    <body onLoad="startIt()">
      ...
      print '<script type="text/javascript">var useTwitter =' . $useTwitter . ', useGoogle=' . $useGoogle . ', usePinterest=' . $usePinterest . ', useFacebook=' . $useFacebook . ', fbApp=' . $facebookAppID . ';</script>';
        ...
        <div id="preload">
          ...
          <img src="sites/all/libraries/jackbox/deploy/jackbox/img/graphics/social/twitter_webkit.png" width="59" height="20" alt="" />
